    ...
    <section ref={scope} className="grid-lines relative min-h-dvh overflow-hidden pt-16">
      ...
      <div className="relative mx-auto flex w-full max-w-[1400px] flex-col items-center px-5 pt-[9vh] sm:px-8">
        ...
        >
          ...
          <span className="absolute right-0 bottom-0 z-10 -rotate-[7deg] translate-y-[38%] rounded-full border border-amber/40 bg-ground/90 px-4 py-1.5 font-mono text-sm uppercase tracking-[0.22em] text-amber backdrop-blur sm:text-base">
            Beta
          </span>
        </h1>
